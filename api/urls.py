...
from .views import GameActionViewSet, GameMoveViewSet, MapContextViewSet, TileContextViewSet, DialogueContextViewSet, DialogueViewSet
...
router.register(r'dialogue', DialogueViewSet)  # Ajout de la vue DialogueViewSet
